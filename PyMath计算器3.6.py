...
# 2.开放源代码 https://github.com/ZhangWzhou/ZhangWenzhou/blob/main/PyMath%E8%AE%A1%E7%AE%97%E5%99%A83.6.py
# 3.免费

print("欢迎使用PyMath计算器 3.6.1!")
print("本计算器提供算术运算：加法（+）、减法（-）、乘法（*）、除法（/）、取余除（%）、取整除（//）、乘方（**）、开方（sqrt()、求绝对值abs()）九种运算；逻辑运算："
